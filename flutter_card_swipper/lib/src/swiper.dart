...
class _TinderState extends _CustomLayoutStateBase<_TinderSwiper> {
  ...
  void afterRender() {
    ...
    _startIndex = -3;
    _animationCount = 5;
    opacity = widget.opciyies ?? [1.0, 1.0, 1.0, 1.0, 0.0, 0.0];
    scales = [0.88, 0.92, 0.96, 1.0, 1.0, 1.0, 1.0];
